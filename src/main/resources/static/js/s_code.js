 ...
 */
//生产
var s_account = "lenovochina-mobilenewshopwap,lenovochina-prd"
if (window.sessionStorage && window.sessionStorage.getItem('s_account')) {
    s_account = window.sessionStorage.getItem('s_account');
} else {
    if (window.location.href.indexOf('.com.cn/weixin/') != -1) {
        s_account = "lenovochina-mobilenewshopweixin,lenovochina-prd";
    } else if (window.location.href.indexOf('.com.cn/android/') != -1) {
        s_account = "lenovochina-mobilenewshopapp,lenovochinanewshop,lenovochina-prd";
    }
}
if (window.sessionStorage) {
    window.sessionStorage.setItem('s_account', s_account);
}
//测试
//var s_account = "lenovochina-dev"
...
var monitor_title = "M2:联想商城WAP";
if (window.sessionStorage && window.sessionStorage.getItem('omtitle')) {
    monitor_title = window.sessionStorage.getItem('omtitle');
} else {
    if (window.location.href.indexOf('.com.cn/weixin/') != -1) {
        monitor_title = "M2:联想商城weixin";
    } else if (window.location.href.indexOf('.com.cn/android/') != -1) {
        monitor_title = "M2:联想商城APP";
    }
}
if (window.sessionStorage) {
    window.sessionStorage.setItem('omtitle', monitor_title);
}
